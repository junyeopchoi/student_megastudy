...
INSERT INTO T_SHOPPING_GOODS VALUES(1,'TEST','TEST',10); #OK

INSERT INTO T_SHOPPING_GOODS VALUES('TEST1','TEST1',20); #ERROR

INSERT INTO T_SHOPPING_GOODS(GOODS_TITLE, GOODS_WRITER, GOODS_PRICE) VALUES('TEST2','TEST2',30); #OK AUTO_INCREMENT

INSERT INTO T_SHOPPING_GOODS(GOODS_TITLE, GOODS_WRITER, GOODS_PRICE) VALUES('TEST2','TEST3',40); #ERROR UNIQUE

INSERT INTO T_SHOPPING_GOODS(GOODS_TITLE, GOODS_WRITER, GOODS_PRICE) VALUES('TEST4','TEST4',NULL); #ERROR NOT NULL

INSERT INTO T_SHOPPING_GOODS(GOODS_TITLE, GOODS_WRITER) VALUES('TEST4','TEST4'); #ERROR NOT NULL

INSERT INTO T_SHOPPING_GOODS(GOODS_TITLE, GOODS_PRICE) VALUES('TEST4',50); #OK


SELECT * FROM T_SHOPPING_GOODS;


# 메인키와 참조키를 사용하지 않았을 경우의 에시
...
UPDATE T_CLASS1 SET CLASS_ID = 'C100' WHERE CLASS_ID = 'C1';

DELETE FROM T_CLASS1 WHERE CLASS_ID = 'C2';



# 메인키와 참조키를 사용하지 않았을 경우의 에시
CREATE TABLE T_CLASS2(
	CLASS_ID 	VARCHAR(10) PRIMARY KEY, #MAIN KEY
    CLASS_NAME 	VARCHAR(10)
);
...
CREATE TABLE T_STUDENT2(
    ...
    STUDENT_NAME VARCHAR(10),
    CLASS_ID 	 VARCHAR(10),
    FOREIGN KEY (CLASS_ID) REFERENCES T_CLASS2(CLASS_ID)
);
...
INSERT INTO T_STUDENT2 VALUES(4 , "빌게이츠" , "C4"); #KEY ERROR (FOREIGN KEY REFERENCES)
INSERT INTO T_STUDENT2 VALUES(5 , "스티브잡스" , "C5"); #KEY ERROR (FOREIGN KEY REFERENCES)

SELECT * FROM T_STUDENT2;
SELECT * FROM T_CLASS2;


UPDATE T_CLASS2 SET CLASS_ID = 'C100' WHERE CLASS_ID = 'C1'; #ERROR (FOREIGN KEY REFERENCES)

DELETE FROM T_CLASS2 WHERE CLASS_ID = 'C2'; #ERROR (FOREIGN KEY REFERENCES)
...
CREATE TABLE T_STUDENT3(
    ...
    ON UPDATE CASCADE #메인키 수정시 참조키 값도 수정
    ON DELETE CASCADE
);
...
INSERT INTO T_STUDENT3 VALUES(4 , "빌게이츠" , "C4"); #KEY ERROR (FOREIGN KEY REFERENCES)
INSERT INTO T_STUDENT3 VALUES(5 , "스티브잡스" , "C5"); #KEY ERROR (FOREIGN KEY REFERENCES)

SELECT * FROM T_STUDENT3;
SELECT * FROM T_CLASS3;


UPDATE T_CLASS3 SET CLASS_ID = 'C100' WHERE CLASS_ID = 'C1'; #OK MAIN KEY, FOREIGN KEY 동시 수정

DELETE FROM T_CLASS3 WHERE CLASS_ID = 'C2'; #OK MAIN KEY, FOREIGN KEY 동시 삭제
